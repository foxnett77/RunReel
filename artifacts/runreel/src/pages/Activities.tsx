  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-black">Le tue attivita</h1>
        <Link href="/upload">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <div className="flex gap-2 flex-wrap">
          {TYPES.map((t) => (
            ...
            >
              {t === "tutti" ? "Tutti" : activityTypeLabel(t)}
            </button>
          ))}
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16 bg-muted/30 rounded-xl border border-dashed border-border">
          ...
          <p className="font-semibold text-foreground mb-1">Nessuna attivita trovata</p>
              ...
              <div className="bg-white rounded-xl border border-border p-4 hover:border-primary/40 hover:shadow-sm transition-all cursor-pointer flex items-center gap-4">
                ...
                <div className="hidden sm:flex gap-6 text-sm">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-xs text-muted-foreground">passo</div>
                  </div>
                </div>
                <button
